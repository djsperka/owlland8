function update_setsnd()
global rec snd
%added size_change2 DJT 3/10/2014
oldpost=snd.post;
%%update all of the values
snd.inter_loom=get(findobj(gcf,'tag','inter_loom'), 'value'); %added by DJT 6/6/2013
...
snd.size_change2=str2num(get(findobj(gcf,'tag','size_change2'),'string'));
