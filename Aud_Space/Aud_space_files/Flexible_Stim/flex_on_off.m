...
%             set(findobj(gcf,'tag','vis_offset2text'),'enable','off');    
            ...
            set(findobj(gcf,'tag','size_change_v2'),'enable','off');
            set(findobj(gcf,'tag','size_change_v2_text'),'enable','off');
...
%             set(findobj(gcf,'tag','vis_offset2text'),'enable','on');    
            ...
            set(findobj(gcf,'tag','size_change_v2'),'enable','on'); 
            set(findobj(gcf,'tag','size_change_v2_text'),'enable','on');
        end
