...
% %                     n2size=1;%length(selectrow);
                    XMatrix1(trialcounter,:,paircounter)=cross/n1size; %Normalize to efficacy
                    XMatrix2(trialcounter,:,paircounter)=cross/n2size; %Normalize to contribution
...
% % mean_matrix1=trial_collapse1;%/(trial_total*spikes.reps); 
% % mean_matrix2=trial_collapse2;%/(trial_total*spikes.reps); 
% % Swap these lines to skip averaging and maintain raw spike counts - DJT 9/16
