function show_raster()
    ...
    switch hist_type
        case 1 %horizontal raster
            ...
            rasterplace=0;
            for i=[1:length(snd.dataVar1)] %for variable
                if snd.datachan(i)==rec.dispch %if spike is from current channel
                        if snd.dataVar2(i)==snd.Var2array(raster_position) %and the selected variable value
                            ...
                            timeraster(rasterplace)=snd.datatime(i); % and this will be used to locat dots horizontally
                        end;
            ...
            plot(timeraster,Var1raster,'linestyle','none','marker','o','markerfacecolor','k','markersize',((10/snd.reps)+4));
        ...
        case 4 %variable 1 raster
            ...
            rasterplace=0;
%  keyboard
            for i=[1:snd.spikeplace_arr1] %for each spike
                if snd.datachan_arr1(i)==rec.dispch %if it occured on the current channel
                    rasterplace=rasterplace+1; 
                    if snd.reps>1
