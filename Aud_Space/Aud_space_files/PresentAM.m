...
%This function pauses the hardware, then loads in all the sound values then
%starts the hardware again.  The hardware then sits there and waits for the
%visual trigger.  Once trigger fires, hardware plays sound
