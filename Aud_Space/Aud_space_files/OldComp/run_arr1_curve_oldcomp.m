...
movedot(snd.window,dotcenter,dotcenter2,fore_lum,fore_lum2,snd.background,angle,snd.angle2,snd.dotsize,snd.dotsize2,snd.pre,snd.amp_mod_vis,snd.Freq_mod,snd.duration,snd.vis_offset,stim_curve, snd.distance, snd.distance2,[play_vis1,play_vis2], snd.size_change, snd.size_change2);      %%set vis and trigger sound
